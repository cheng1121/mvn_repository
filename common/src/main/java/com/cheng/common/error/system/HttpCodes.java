...
public enum HttpCodes implements IErrorCode {
    ...
    public static enum Series {
        ...
        public static HttpCodes.Series valueOf(HttpCodes status) {
            return valueOf( status.status);
        }

        public static HttpCodes.Series valueOf(int statusCode) {
            HttpCodes.Series series = resolve(statusCode);
            if (series == null) {
                throw new IllegalArgumentException("No matching constant for [" + statusCode + "]");
            } else {
                return series;
        ...
        public static HttpCodes.Series resolve(int statusCode) {
            int seriesCode = statusCode / 100;
            HttpCodes.Series[] var2 = values();
            int var3 = var2.length;

            for(int var4 = 0; var4 < var3; ++var4) {
                HttpCodes.Series series = var2[var4];
